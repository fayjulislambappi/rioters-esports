    ...
    return (
        <Card className="group relative h-[400px] flex flex-col justify-end p-0 border-0 overflow-hidden">
            ...
            <div className="relative p-6 z-10 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                ...
                <h3 className="text-2xl md:text-3xl font-black uppercase italic mb-2 text-white group-hover:text-primary transition-colors">
                    {title}
                </h3>
                ...
                <Link href={`/games/${slug}`}>
                    <Button asDiv variant="neon" size="sm" className="w-full group-hover:bg-accent group-hover:text-white">
