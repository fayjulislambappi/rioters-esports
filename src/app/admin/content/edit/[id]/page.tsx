...
export default function EditArticlePage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (loading) {
        return <div className="p-8 text-center animate-pulse uppercase font-black tracking-widest text-white/20">Loading Article Data...</div>;
    }
    ...
    return (
        <div className="max-w-4xl mx-auto pb-20">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-3xl font-black uppercase tracking-tighter">Edit Article</h1>
                    <p className="text-white/40 text-sm italic uppercase font-bold">Update your news entry</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-8">
                    ...
                    <Button variant="neon" className="w-full py-6" onClick={handleSubmit} disabled={saving}>
