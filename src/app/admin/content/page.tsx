...
import { Search, FileText, Trash2, Plus, Calendar, User, Edit } from "lucide-react";
                                    ...
                                    <tr key={article._id} className="hover:bg-white/5 transition-colors">
                                        <td className="p-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div className="font-bold text-sm leading-tight mb-1">{article.title}</div>
                                        ...
                                        <td className="p-4 text-sm">
                                            <span className="bg-primary/20 text-primary px-2 py-1 rounded text-[10px] font-bold uppercase">
                                                {article.category}
                                            </span>
                                        </td>
                                        ...
                                        <td className="p-4 text-right">
                                            <div className="flex justify-end gap-2">
                                                <Link href={`/admin/content/edit/${article._id}`}>
